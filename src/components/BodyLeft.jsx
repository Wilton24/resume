    ...
    <div className="body-left">
      <div className="profile">
        ...
        <p>
          ...
          library, spends eight to twelve hours daily on the computer --
          creating projects and solving leet codes. Competent and effective in
          communication and collaboration with back-end developers, designers,
